...
package com.sciencearts.rtspstreaming.gles;
...
public class Drawable2d {
    ...
    private static final float FULL_MIRROR_RECTANGLE_TEX_COORDS[] = {
            1.0f, 1.0f,      // 3 top right
    ...
    private static final FloatBuffer FULL_MIRROR_RECTANGLE_TEX_BUF =
            GlUtil.createFloatBuffer(FULL_MIRROR_RECTANGLE_TEX_COORDS);
     ...
     */
    public enum Prefab {
        TRIANGLE, RECTANGLE, FULL_RECTANGLE, FULL_MIRROR_RECTANGLE
    }
    ...
    public Drawable2d(Prefab shape) {
        switch (shape) {
            ...
            case FULL_RECTANGLE:
                ...
                break;
            case FULL_MIRROR_RECTANGLE:
                mVertexArray = FULL_RECTANGLE_BUF;
                mTexCoordArray = FULL_MIRROR_RECTANGLE_TEX_BUF;
                mCoordsPerVertex = 2;
                mVertexStride = mCoordsPerVertex * SIZEOF_FLOAT;
                mVertexCount = FULL_RECTANGLE_COORDS.length / mCoordsPerVertex;
                break;
